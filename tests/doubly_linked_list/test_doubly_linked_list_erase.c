...
check_static_begin(doubly_linked_list_test_pop_empty) {
    ...
    check(doubly_linked_list_pop_front(&doubly_linked_list, &(CCC_Allocator){}),
          CCC_RESULT_ARGUMENT_ERROR);
    check(doubly_linked_list_validate(&doubly_linked_list), true);
    check(doubly_linked_list_pop_back(&doubly_linked_list, &(CCC_Allocator){}),
          CCC_RESULT_ARGUMENT_ERROR);
    check(doubly_linked_list_validate(&doubly_linked_list), true);
