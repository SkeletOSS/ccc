...
check_static_begin(bitset_test_set_range) {
    Bitset bs = bitset_with_storage(512, bitset_storage_for(512));
...
check_static_begin(bitset_test_or_same_size) {
    Bitset source = bitset_with_storage(512, bitset_storage_for(512));
    Bitset destination = bitset_with_storage(512, bitset_storage_for(512));
...
check_static_begin(bitset_test_or_diff_size) {
    ...
    Bitset source = bitset_with_storage(244, bitset_storage_for(244));
...
check_static_begin(bitset_test_subset) {
    Bitset set = bitset_with_storage(512, bitset_storage_for(512));
    Bitset subset1 = bitset_with_storage(512, bitset_storage_for(512));
    Bitset subset2 = bitset_with_storage(244, bitset_storage_for(244));
...
validate_sudoku_box(int board[9][9], Bitset *const row_check,
    ...
    Bitset box_check = bitset_with_storage(9, bitset_storage_for(9));
...
check_static_begin(bitset_test_valid_sudoku) {
    ...
    /* clang-format on */
    Bitset row_check
        = bitset_with_storage(9L * 9L, bitset_storage_for(9L * 9L));
    Bitset col_check
        = bitset_with_storage(9L * 9L, bitset_storage_for(9L * 9L));
