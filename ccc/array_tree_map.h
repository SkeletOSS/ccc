...
The CCC_array_tree_map_fixed_capacity macro can be used to obtain
...
initialize a dynamic map and use the CCC_array_tree_map_reserve
...
#define CCC_array_tree_map_fixed_capacity(fixed_map_type_name)                 \
...
#define CCC_array_tree_map_from(type_key_field, compare, allocate,             \
...
#define CCC_array_tree_map_with_capacity(type_name, type_key_field, compare,   \
                                         allocate, context_data, capacity)     \
...
status is returned.
@note see the CCC_array_tree_map_clear_and_free_reserve function if
...
[[nodiscard]] void *CCC_array_tree_map_at(CCC_Array_tree_map const *handle,
...
stored in the map. */
#define CCC_array_tree_map_as(array_tree_map_pointer, type_name,               \
                              array_index...)                                  \
...
CCC_array_tree_map_get_key_value(CCC_Array_tree_map const *map,
                                 void const *key);
...
[[nodiscard]] CCC_Handle CCC_array_tree_map_swap_handle(CCC_Array_tree_map *map,
                                                        void *type_output);
...
[[nodiscard]] CCC_Handle CCC_array_tree_map_try_insert(CCC_Array_tree_map *map,
                                                       void const *type);
...
[[nodiscard]] CCC_Handle_index
CCC_array_tree_map_or_insert(CCC_Array_tree_map_handle const *handle,
                             void const *type);
...
[[nodiscard]] CCC_Handle_index
CCC_array_tree_map_insert_handle(CCC_Array_tree_map_handle const *handle,
                                 void const *type);
...
@param[in] map the map to be cleared.
@param[in] destroy the destructor for each element. NULL can be passed if no
maintenance is required on the elements in the array_tree_map
before their slots are dropped.
@param[in] allocate the required allocation function to provide to a
dynamically reserved array_tree_map. Any context data provided upon
...
array_tree_map at runtime but denying the
array_tree_map allocation permission to resize. This can help
prevent a map from growing untree. The user in this
...
CCC_array_tree_map_equal_range(CCC_Array_tree_map const *map,
...
CCC_array_tree_map_equal_range_reverse(CCC_Array_tree_map const *map,
...
traversal. */
[[nodiscard]] CCC_Handle_index
CCC_array_tree_map_next(CCC_Array_tree_map const *map,
...
inorder traversal. */
[[nodiscard]] CCC_Handle_index
CCC_array_tree_map_reverse_next(CCC_Array_tree_map const *map,
                                CCC_Handle_index iterator);
...
#    define array_tree_map_reserve(args...) CCC_array_tree_map_reserve(args)
#    define array_tree_map_at(args...) CCC_array_tree_map_at(args)
#    define array_tree_map_as(args...) CCC_array_tree_map_as(args)
#    define array_tree_map_and_modify_with(args...)                            \
        CCC_array_tree_map_and_modify_with(args)
#    define array_tree_map_or_insert_with(args...)                             \
        CCC_array_tree_map_or_insert_with(args)
#    define array_tree_map_insert_array_with(args...)                          \
        CCC_array_tree_map_insert_array_with(args)
#    define array_tree_map_try_insert_with(args...)                            \
        CCC_array_tree_map_try_insert_with(args)
#    define array_tree_map_insert_or_assign_with(args...)                      \
        CCC_array_tree_map_insert_or_assign_with(args)
#    define array_tree_map_contains(args...) CCC_array_tree_map_contains(args)
#    define array_tree_map_get_key_value(args...)                              \
        CCC_array_tree_map_get_key_value(args)
#    define array_tree_map_swap_handle(args...)                                \
        CCC_array_tree_map_swap_handle(args)
#    define array_tree_map_swap_handle_wrap(args...)                           \
        CCC_array_tree_map_swap_handle_wrap(args)
#    define array_tree_map_begin(args...) CCC_array_tree_map_begin(args)
#    define array_tree_map_reverse_begin(args...)                              \
        CCC_array_tree_map_reverse_begin(args)
#    define array_tree_map_next(args...) CCC_array_tree_map_next(args)
#    define array_tree_map_reverse_next(args...)                               \
        CCC_array_tree_map_reverse_next(args)
#    define array_tree_map_end(args...) CCC_array_tree_map_end(args)
#    define array_tree_map_reverse_end(args...)                                \
        CCC_array_tree_map_reverse_end(args)
#    define array_tree_map_is_empty(args...) CCC_array_tree_map_is_empty(args)
#    define array_tree_map_count(args...) CCC_array_tree_map_count(args)
#    define array_tree_map_capacity(args...) CCC_array_tree_map_capacity(args)
#    define array_tree_map_clear(args...) CCC_array_tree_map_clear(args)
#    define array_tree_map_clear_and_free(args...)                             \
        CCC_array_tree_map_clear_and_free(args)
#    define array_tree_map_clear_and_free_reserve(args...)                     \
        CCC_array_tree_map_clear_and_free_reserve(args)
#    define array_tree_map_validate(args...) CCC_array_tree_map_validate(args)
