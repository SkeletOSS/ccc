...
main(void)
{
    void *const map = malloc(
        sizeof(
            CCC_array_adaptive_map_declare_compound_literal(
                (structVal[4096]){}
            )
        )
    );
...
#define CCC_array_adaptive_map_declare_compound_literal(                       \
    user_type_compound_literal_array, optional_storage_specifier...)           \
    CCC_private_array_adaptive_map_declare_compound_literal(                   \
        user_type_compound_literal_array, optional_storage_specifier)
...
#    define array_adaptive_map_declare_compound_literal(arguments...)          \
        CCC_array_adaptive_map_declare_compound_literal(arguments)
