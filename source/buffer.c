...
CCC_Result
CCC_buffer_swap(CCC_Buffer const *const buffer, void *const temp,
...
void *
CCC_buffer_move(CCC_Buffer const *const buffer, size_t const destination,
                size_t const source) {
...
CCC_Result
CCC_buffer_write(CCC_Buffer const *const buffer, size_t const i,
